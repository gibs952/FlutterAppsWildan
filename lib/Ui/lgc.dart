...
class _UpdatePageState extends State<UpdPage> {
  ...
  void initState() {
    super.initState();
    fakturController =
        TextEditingController(text: widget.initialData['faktur']);
    tanggalController =
        TextEditingController(text: widget.initialData['tanggal']);
    customerController =
        TextEditingController(text: widget.initialData['customer']);
    jumlahController =
        TextEditingController(text: widget.initialData['jumlah']);
